...
$('.referral-tracker').referralTracker({
          rewardLevels: [3,5,10,15,20],
          prizes: ['<h4>50% off</h4><p>Early-bird pricing on all products.</p>', 
            '<h4>Get 1 Free</h4><p>Get your first shirt for free.</p>', 
            '<h4>Get 2 Free</h4><p>Get your second shirt for free.</p>', 
            '<h4>Get 3 Free</h4><p>Get your third shirt for free.</p>', 
            '<h4>Get 4 Free</h4><p>Get your fourth shirt for free.</p>'],
          referralsEarned: 15,
          showMessage: true,
          singularMessage: 'invited friend has joined. Keep checking.', 
          pluralMessage: 'invited friends have joined. Keep checking.',
